...
var _AddDeleteDocElementCmd = __webpack_require__(17);
...
var _CommandGroupCmd = __webpack_require__(18);
...
var TableTextElement = function (_TextElement) {
    ...
    (0, _createClass3.default)(TableTextElement, [{
        ...
        key: 'getProperties',
        value: function getProperties() {
            var fields = ['xReadOnly', 'width', 'content', 'eval', 'colspan', 'styleId', 'bold', 'italic', 'underline', 'strikethrough', 'horizontalAlignment', 'verticalAlignment', 'textColor', 'backgroundColor', 'font', 'fontSize', 'lineSpacing', 'paddingLeft', 'paddingTop', 'paddingRight', 'paddingBottom', 'pattern', 'link', 'cs_condition', 'cs_styleId', 'cs_bold', 'cs_italic', 'cs_underline', 'cs_strikethrough', 'cs_horizontalAlignment', 'cs_verticalAlignment', 'cs_textColor', 'cs_backgroundColor', 'cs_font', 'cs_fontSize', 'cs_lineSpacing', 'cs_paddingLeft', 'cs_paddingTop', 'cs_paddingRight', 'cs_paddingBottom'];
            var tableBandObj = this.rb.getDataObject(this.parentId);
...
var StylePanel = function (_PanelBase) {
    ...
    (0, _createClass3.default)(StylePanel, [{
        ...
        value: function renderStyle(elPanel, idPrefix, fieldPrefix, renderDocElementMainStyle, rb) {
            ...
            elFormField = $('<div class="rbroFormField"></div>');
            var elBorderWidth = $('<input id="rbro_' + idPrefix + 'border_width" type="number">').on('input', function (event) {
...
var ReportBro = function () {
    function ReportBro(element, properties) {
        ...
        this.docElementPanel = new _DocElementPanel2.default(element, this);
    ...
    (0, _createClass3.default)(ReportBro, [{
        ...
        value: function load(report) {
            ...
            if (report.version < 3) {
                ...
                try {
                    for (var _iterator35 = (0, _getIterator3.default)(report.docElements), _step35; !(_iteratorNormalCompletion35 = (_step35 = _iterator35.next()).done); _iteratorNormalCompletion35 = true) {
                        var _docElementData = _step35.value;
            ...
            try {
                for (var _iterator38 = (0, _getIterator3.default)(report.docElements), _step38; !(_iteratorNormalCompletion38 = (_step38 = _iterator38.next()).done); _iteratorNormalCompletion38 = true) {
                    var _docElementData2 = _step38.value;
        ...
        value: function getParameterByName(parameterName) {
            ...
            try {
                for (var _iterator39 = (0, _getIterator3.default)(parameters), _step39; !(_iteratorNormalCompletion39 = (_step39 = _iterator39.next()).done); _iteratorNormalCompletion39 = true) {
                    var parameter = _step39.value;
        ...
        value: function updateDisplay(field) {
            ...
            try {
                for (var _iterator2 = (0, _getIterator3.default)(selectedObjects), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                    ...
                    var properties = _obj2.getProperties();
                    var _iteratorNormalCompletion6 = true;
                    var _didIteratorError6 = false;
                    var _iteratorError6 = undefined;

                    try {
                        for (var _iterator6 = (0, _getIterator3.default)(properties), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
                            var _property2 = _step6.value;
                ...
                for (var _property in this.propertyDescriptors) {
                    if (this.propertyDescriptors.hasOwnProperty(_property)) {
                        ...
                        if ('rowId' in _propertyDescriptor && 'rowProperties' in _propertyDescriptor) {
                            ...
                            try {
                                for (var _iterator4 = (0, _getIterator3.default)(_propertyDescriptor['rowProperties']), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
                                    var _rowProperty = _step4.value;
                    ...
                    if (elParameterName.val().trim() !== '') {
                        ...
                        try {
                            for (var _iterator2 = (0, _getIterator3.default)(_this2.rb.getParameters()), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                                ...
                                _parameter.addCommandsForChangedParameterName(selectedObject, newParameterName, cmdGroup);
                            }
                        } catch (err) {
                            _didIteratorError2 = true;
                            _iteratorError2 = err;
